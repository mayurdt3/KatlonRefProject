...
WebUI.setText(findTestObject('Object Repository/Airbnb/Page_Search/input_Where_query'), 'Tokyo')
...
WebUI.verifyElementText(findTestObject('Airbnb/Page_SearchResult/span_Search resultsOver 1,000 places in Atlanta'), 'Over 1,000 places in Tokyo')
