...
WebUI.callTestCase(findTestCase('Reuse Test Case/Healthcare/RTC009_Login into application invalid username and password'), [:], FailureHandling.STOP_ON_FAILURE)
